...
<p>
Attention weights were visualized to understand which tokens contributed most to predictions. 
These visualizations provide qualitative insight into model behavior, particularly for misclassified examples.
</p>

<p>
The analysis revealed that the model often focuses on emotionally charged words, but may still misinterpret overall sentence meaning when context is subtle or ambiguous.
</p>
